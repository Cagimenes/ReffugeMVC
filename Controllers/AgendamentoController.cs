...
namespace ReffugeMVC.Controllers
{
    public class AgendamentoController : Controller
    {
        ...
        {
            var contexto = _context.Agendamento.Include(a => a.Cliente).Include(a => a.Profissional);
        ...
        public async Task<IActionResult> Create([Bind("AgendamentoId,ClienteId,DataHora,ProfissionalId")] Agendamento agendamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AgendamentoId,ClienteId,DataHora,ProfissionalId")] Agendamento agendamento)
        {
